...
export interface BridgeHarness {
  ...
  onSessionUpdate: ((params: SessionNotification) => Promise<void>) | undefined
...
export async function makeBridgeHarness(options: {
  ...
  attachments?: boolean
  beforeAcp?: (ctx: Context) => void | Promise<void>
  ...
  const makeClient = (_agent: AcpAgent): Client => ({
    sessionUpdate(params: SessionNotification): Promise<void> {
      ...
      if (harness.onSessionUpdate !== undefined) return harness.onSessionUpdate(params)
